...
#     go_lil_right
# from self_driving_car_with_python.methods_processing_frames import pre_process_frame, make_gray_frame_custDimensions, modify_frame_480x270gray
from self_driving_car_with_python.methods_neural_network import test_model
...
#     # file_name = 'training_data160120-1.npy'  # new training data
...
#     training_data = np.load('training_data160120-1.npy', allow_pickle=True)  # shuffle new training data
#     shuffle_training_data(training_data)  # shuffle new training data
#
#
# def execute_to_train_data():
#     # shuffled_training_data = np.load('training_data160120-1.npy', allow_pickle=True)  # shuffle new training data
#     # train_data(shuffled_training_data, screen_width=160, screen_height=120)  # train new training data
#     train_data_new()
...
#     if not paused:
#         frame = take_frame()
#         resized_screen = make_gray_frame_custDimensions(frame)
#
